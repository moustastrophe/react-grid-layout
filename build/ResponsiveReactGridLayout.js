...
var ResponsiveReactGridLayout = function (_React$Component) {
  ...
  ResponsiveReactGridLayout.prototype.generateInitialState = function generateInitialState() {
    ...
    var breakpoint = (0, _responsiveUtils.getBreakpointFromWidth)(breakpoints, widthForBreakpoint);
  ...
  ResponsiveReactGridLayout.prototype.onWidthChange = function onWidthChange(nextProps) {
    ...
    var widthForBreakpoint = breakpointFromViewport ? viewportWidth : width;
    var newBreakpoint = nextProps.breakpoint || (0, _responsiveUtils.getBreakpointFromWidth)(nextProps.breakpoints, widthForBreakpoint);

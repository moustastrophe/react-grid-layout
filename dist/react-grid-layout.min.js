    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (k["[object Float32Array]"] = k["[object Float64Array]"] = k[
          ...
          (k[u] = k[l] = k[D] = k[f] = k[j] = k[p] = k[d] = k[h] = k[g] = k[
            m
          ...
          return (
            ...
            (null == t || null == e || (!Jt(t) && !Jt(e))
              ...
              : (function(t, e, n, r, o, s) {
                  ...
                  if (!(n & a)) {
                    var T = w && K.call(t, "__wrapped__"),
                      k = _ && K.call(e, "__wrapped__");
                    if (T || k) {
                      var C = T ? t.value() : t,
                        z = k ? e.value() : e;
                      return s || (s = new jt()), o(C, z, n, r, s);
                    }
                  }
                  if (!E) return !1;
                  return (
        ...
        function Pt(t) {
          return (
            !(!$t(t) || ((e = t), Q && Q in e)) && (Ft(t) ? tt : E).test(Yt(t))
          );
          var e;
        }
        function Mt(t) {
        ...
        ((ct && Ht(new ct(new ArrayBuffer(1))) != j) ||
          (ft && Ht(new ft()) != g) ||
          (pt && "[object Promise]" != Ht(pt.resolve())) ||
          (dt && Ht(new dt()) != S) ||
        ...
        function Qt(t) {
          return null != (e = t) && Gt(e.length) && !Ft(e) ? Et(t) : Mt(t);
          var e;
        }
    ...
    function(t, e, n) {
        ...
        return (
          ...
          (e.prototype.onDrag = function(t, e, n, r) {
            var o = r.e,
              ...
              s = this.state.layout,
              l = this.props,
              c = l.collisonResolver,
              f = l.preventCollision,
              p = l.cols,
              d = l.onDrag,
              h = l.compactor,
              y = (0, u.getLayoutItem)(s, t);
            if (y) {
              var g = { w: y.w, h: y.h, x: y.x, y: y.y, placeholder: !0, i: t };
              d(
                (s = c(s, y, e, n, !0, f, this.compactType(), p)),
                i,
                y,
                g,
                o,
          ...
          (e.prototype.onDragStop = function(t, e, n, r) {
            ...
            if (y) {
              d(
                (s = c(s, y, e, n, !0, p, this.compactType(), f)),
                i,
                y,
                null,
                o,
              ...
              var g = h(s, this.compactType(), f),
                m = this.state.oldLayout;
              this.setState({
                activeDrag: null,
                layout: g,
                oldDragItem: null,
          ...
          (e.prototype.onResizeStop = function(t, e, n, r) {
            ...
            this.props.onResizeStop(s, l, d, null, o, a);
            var h = p(s, this.compactType(), f),
      ...
      (f.displayName = "ReactGridLayout"),
        (f.propTypes = {
          ...
          collisonResolver: a.default.oneOfType([a.default.func]),
          compactor: a.default.oneOfType([a.default.func]),
        ...
        (f.defaultProps = {
          ...
          preventCollision: !1,
          collisonResolver: u.moveElement,
          compactor: u.compact,
...
*/
        ...
        return (
          ...
          (e.prototype.calcPosition = function(t, e, n, r, o) {
            var a = this.props,
              ...
              c = a.unit,
              f = this.calcColWidth(),
              p = (0, u.getViewportSize)(c),
              d = {
                left: (f + i[0]) * t + s[0],
                top: (l + i[1]) * e + s[1],
                width: n === 1 / 0 ? n : f * n + Math.max(0, n - 1) * i[0],
                height: r === 1 / 0 ? r : l * r + Math.max(0, r - 1) * i[1]
              };
            return (
              o &&
                o.resizing &&
                ((d.width = o.resizing.width), (d.height = o.resizing.height)),
              o &&
                o.dragging &&
                ((d.top = o.dragging.top),
                (d.left = o.dragging.left),
                (0, u.isUnitRelative)(c) &&
                  ((d.top = (100 * d.top) / p), (d.left = (100 * d.left) / p))),
              d
            );
          }),
          (e.prototype.calcXY = function(t, e) {
            ...
            (0, u.isUnitRelative)(c) &&
              ((e = (100 * e) / p), (t = (100 * t) / p));
            var d = Math.round((e - r[0]) / (f + r[0])),
              h = Math.round((t - r[1]) / (a + r[1]));
            return {
              x: (d = Math.max(Math.min(d, o - i), 0)),
              y: (h = Math.max(Math.min(h, l - s), 0))
            };
          }),
          ...
          (e.prototype.mixinResizable = function(t, e, n) {
            var r = this.props,
              ...
              p = r.maxH,
              d = r.unit,
              h = (0, u.getViewportSize)(d),
              y = this.calcPosition(0, 0, a - i, 0).width;
            (0, u.isUnitRelative)(d) && (y = (y * h) / 100);
            var g = this.calcPosition(0, 0, l, c);
            (0, u.isUnitRelative)(d) &&
              ((g.width = (g.width * h) / 100),
              (g.height = (g.height * h) / 100));
            var m = this.calcPosition(0, 0, f, p);
            (0, u.isUnitRelative)(d) &&
              ((m.width = (m.width * h) / 100),
              (m.height = (m.height * h) / 100));
            var v = [g.width, g.height],
              b = [Math.min(m.width, y), Math.min(m.height, 1 / 0)];
            return (
              (0, u.isUnitRelative)(d) &&
                ((e.width = (e.width * h) / 100),
                (e.height = (e.height * h) / 100)),
              o.default.createElement(
                s.Resizable,
                {
          ...
          (e.prototype.onResizeHandler = function(t) {
            ...
            return function(n, r) {
              ...
              if (i) {
                ...
                (b = Math.min(b, l - c)),
                  (b = Math.max(b, 1)),
                  (b = Math.max(Math.min(b, p), d)),
                  (w = Math.max(Math.min(w, h), y)),
                  e.setState({ resizing: "onResizeStop" === t ? null : a }),
                  i.call(e, f, b, w, { e: n, node: o, size: a });
              }
            };
          }),
          (e.prototype.render = function() {
            ...
            return (
              (d = this.mixinResizable(d, f, u)),
              (d = this.mixinDraggable(d, s))
            );
          }),
          e
        );
	...
	*/
        ...
        var T = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < j.length; n++) if (E(t, j[n]) in e) return j[n];
            return "";
          })(),
          k = function(t, e) {
            if (!(t instanceof e))
        ...
        function Y(t) {
          ...
          return (e += _(n.borderTopWidth)), (e += _(n.borderBottomWidth));
        }
        function X(t) {
          var e = t.clientWidth,
            n = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e += _(n.borderLeftWidth)), (e += _(n.borderRightWidth));
        }
        function U(t) {
          var e = t.clientHeight,
            n = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e -= _(n.paddingTop)), (e -= _(n.paddingBottom));
        }
        function q(t) {
          var e = t.clientWidth,
            n = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e -= _(n.paddingLeft)), (e -= _(n.paddingRight));
        }
        function V(t, e, n) {
          var r = t.x,
            o = t.y,
                  ...
                  if (
                    ...
                    if (null != i) {
                      ...
                      !1 !== c &&
                        ...
                        H(r, rt.move, o.handleDrag),
                        H(r, rt.stop, o.handleDragStop));
                    }
                  }
                }),
                ...
                if (e.props.bounds) {
                  ...
                  var s = (function(t, e, n) {
                      ...
                      if ("string" == typeof r) {
                        ...
                        r = {
                          left:
                            -o.offsetLeft + _(l.paddingLeft) + _(u.marginLeft),
                          top: -o.offsetTop + _(l.paddingTop) + _(u.marginTop),
                          right:
                            q(s) -
                            X(o) -
                            o.offsetLeft +
                ...
                value: function() {
                  ...
                  var c = this.props,
                    ...
                    y = x(
                      h.props.className || "",
                      f,
                      (z((t = {}), p, this.state.dragging),
                      z(t, d, this.state.dragged),
                      t)
                    );
                  ...
                  if (o.state.dragging) {
                    ...
                    if (null != n) {
                      var r = n.x,
                        ...
                        i = Q(o, r, a),
                        s = t.findDOMNode(o);
                      s && o.props.enableUserSelectHack && F(s.ownerDocument),
                        o.setState({ dragging: !1, lastX: NaN, lastY: NaN }),
                        o.props.onStop(e, i),
                        s &&
              ...
              },
              {
                ...
                value: function() {
                  ...
                  var f = this.props,
                    ...
                    d = f.defaultClassNameDragging,
                    h = f.defaultClassNameDragged,
                    y = e.Children.only(this.props.children),
                    g = x(
                      y.props.className || "",
                      p,
                      (z((t = {}), d, this.state.dragging),
                      z(t, h, this.state.dragged),
                      t)
                    );
                  return e.createElement(
                    rt,
          ...
          return (
            ...
            (e.prototype.onWidthChange = function(t) {
              var e = t.breakpointFromViewport,
                ...
                d = (0, u.getColsFromBreakpoint)(f, r);
              if (
                p !== f ||
                this.props.breakpoints !== n ||
                this.props.cols !== r
              ) {
                p in o || (o[p] = (0, s.cloneLayout)(this.state.layout));
                var h = (0, u.findOrGenerateResponsiveLayout)(o, n, f, p, d, a);
                (h = (0, s.synchronizeLayoutWithChildren)(h, t.children, d, a)),
                  (o[f] = h),
                  this.props.onBreakpointChange(f, d),
                  this.props.onLayoutChange(h, o),
                  this.setState({ breakpoint: f, layout: h, cols: d });
              }

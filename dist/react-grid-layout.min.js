    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (E["[object Float32Array]"] = E["[object Float64Array]"] = E[
          ...
          (E[u] = E[l] = E[j] = E[p] = E[z] = E[f] = E[h] = E[d] = E[g] = E[
            m
        ...
        return (
          ...
          (e.prototype.mixinResizable = function(t, e) {
            var n = this.props,
              ...
              p = n.maxH,
              f = n.unit,
              h = (0, u.getViewportSize)(f),
              d = this.calcPosition(0, 0, r - a, 0).width;
            (0, u.isUnitRelative)(f) && (d = (d * h) / 100);
            var y = this.calcPosition(0, 0, i, l);
            (0, u.isUnitRelative)(f) &&
              ((y.width = (y.width * h) / 100),
              (y.height = (y.height * h) / 100));
            var g = this.calcPosition(0, 0, c, p);
            (0, u.isUnitRelative)(f) &&
